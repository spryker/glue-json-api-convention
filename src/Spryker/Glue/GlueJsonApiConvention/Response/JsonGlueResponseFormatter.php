...
class JsonGlueResponseFormatter implements JsonGlueResponseFormatterInterface
{
    ...
    /**
     * @var \Spryker\Glue\GlueJsonApiConvention\Response\ResponseSparseFieldFormatter
     */
     ...
     * @param \Spryker\Glue\GlueJsonApiConvention\Response\ResponseSparseFieldFormatter $responseSparseFieldFormatter
     */
    public function __construct(
        EncoderInterface $jsonEncoder,
        GlueJsonApiConventionConfig $jsonApiConventionConfig,
        ResponseSparseFieldFormatter $responseSparseFieldFormatter
    ) {
    ...
    public function formatResponseData(
        ...
        if ($sparseFields && isset($responseData[static::RESPONSE_INCLUDED])) {
            $responseData = $this->responseSparseFieldFormatter->format($sparseFields, $responseData);
        }

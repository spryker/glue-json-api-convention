...
interface ResourceTypeRequestAfterRoutingValidatorInterface
{
    /**
     * Validates that the `data.type` field in the JSON:API request body matches the resource type resolved by routing.
     *
